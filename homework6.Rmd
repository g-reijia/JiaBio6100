...
```{r}
plantpopulation1 <- rnorm(n=10, mean = 15, sd = 2)
plantpopulation2 <- rnorm(n=10, mean = 15, sd = 2)
...
for (i in n_iterations) {
  plantpopulation1 <- rnorm(n=i, mean = 15, sd = 2)
  plantpopulation2 <- rnorm(n=i, mean = 15, sd = 2)
  Plant_Populations <- c(plantpopulation1, plantpopulation2)
  Group_Name <- c(rep("Plant_Population_1", length(plantpopulation1)),rep("Plant_Population_2",length(plantpopulation2)))
  test_result <- t.test(Plant_Populations)
